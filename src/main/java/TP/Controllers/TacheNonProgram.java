...
public class TacheNonProgram implements Initializable {
    @FXML
    ...
    public void ajouterTaskButton()
    {
        ...
        ajouterTask.setOnMouseClicked(MouseEvent->{
            ...
            {
                tacheSimple.setEtatDeRealisation(EtatDeRealisation.unscheduled);
                LoginController.getUser().getPlanningCourant().getTaches().add(tacheSimple);
